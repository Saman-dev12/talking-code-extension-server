...
exports.chainWithHistory = exports.chain = void 0;
...
const promptForHistory = prompts_1.ChatPromptTemplate.fromMessages([
    [
        "system",
        `
...
exports.chain = prompt.pipe(llm).pipe(new output_parsers_1.StringOutputParser());
exports.chainWithHistory = promptForHistory
    .pipe(llm)
